...
Le node aveugle (store-and-forward) tourne désormais sur le **Raspberry Pi** (pi@10.0.0.2),
...
- Exposition WAN : **wss://relai.exemple** via Cloudflare Tunnel `portfolio`
...
- Client : `DEFAULT_RELAY = wss://relai.exemple`. Override dev :
